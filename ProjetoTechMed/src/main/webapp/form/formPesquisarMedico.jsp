...
<body>
	...
	<div class="container d-flex flex-column">
		...
		<form action="../relatorioMedico" method="post" class="form-container p-4">
			<h3 class="text-center mb-3">Pesquisar médico</h3>

			<select name="medico" class="form-select my-5">
				<option value="" disabled selected>Esolha um médico</option>
			...
			<div class="d-flex justify-content-between mt-3">
				...
				<button class="submit" style="padding: none;">Gerar relatório</button>
			</div>
		</form>
	</div>
